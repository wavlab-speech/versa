...
def main():
    ...
    if args.category and args.metrics:
        raise ValueError("Please specify only one of --category or --metrics, not both.")
    ...
    if args.save_html:
        ...
        print(f'results saved to radar_chart.html, please download and open in local browser.')
    else:
        fig.show()
